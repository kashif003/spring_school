...
sound_files = [
        ...
        ("hello1.wav", "voice/agent win1.wav"),
        ("hello2.wav", "voice/agent win1.wav"),
        ("hello3.wav", "voice/agent win1.wav"),
        ("player turn2.wav", "voice/agent win1.wav"),
        ("player turn.wav", "voice/agent win1.wav"),
        ("player win1.wav", "voice/agent win1.wav"),
        ("player win3.wav", "voice/agent win3.wav")
    ]
